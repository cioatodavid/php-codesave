                ...
                <table class="table table-light">
                  ...
                  <tbody>
                    ...
                    foreach ($snippets as $snippet) {
                      $user = getUserById($snippet['user_profile_id']);
                      $user_name = $user[0]['name'];
                      $snippet_id = $snippet['id'];
                      $snippet_title = $snippet['title'];
                      $snippet_trigger = $snippet['trigger'];
                      $snippet_date = $snippet['publishedAt'];
                      tableRowSnippet($snippet_id, $user_name, $snippet_title, $snippet_trigger, $snippet_date);
                    }

                    ?>
                  </tbody>
                </table>
                <a name="" id="" class="btn btn-primary" href="./snippetInsert.php" role="button">Cadastrar novo snippet</a>
              </div>
            </div>
          </div>
      </main>
