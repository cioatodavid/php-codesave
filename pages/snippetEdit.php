    ...
    <div id="layoutSidenav_content">
      <main>
        <div class="container-fluid px-4">
          <h1 class="mt-4">Editar Snippet</h1>

          <form action="../utils/update.php" method="post" enctype="multipart/form-data">
            <input type="hidden" name="snippet">
            <input type="hidden" name="id" value="<?php echo $snippet['id'] ?>">
            <div class="card mb-4">
              <div class="card-header">
                <i class="fas fa-table me-1"></i>
                <?php echo "ID: " . $snippet['id'] ?>
              </div>
              <div class="card-body">
                <div class="mb-3">
                  <label for="title" class="form-label">Título</label>
                  <input type="text" name="title" value="<?php echo $snippet['title'] ?>" class="form-control" placeholder="">
                </div>
                <div class="mb-3">
                  <div class="mb-3">
                    ...
                    <select class="form-select" name="user_profile_id">
                      ...
                      foreach ($users as $user) {
                        if ($user['id'] == $snippet['user_profile_id']) {
                ...
                <div class="mb-3">
                  ...
                  <input type="text" name="trigger" value="<?php echo $snippet['trigger'] ?>" class="form-control" placeholder="">
                </div>
                
                <div class="mb-3">
                  <label for="formFile" class="form-label">Snippet</label>
                  <input class="form-control" name="blob" type="file" id="formFile">
                  <p class="form-text text-muted">
                    Caso não seja adicionado nenhum arquivo, será mantido o arquivo atual.
                  </p>
                </div>
